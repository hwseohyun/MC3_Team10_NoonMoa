...
extension User {
    ...
    [
        [User(id: "AAAA", roomId: "1", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeYellow", token: "a",requestedBy: []),
         User(id: "BBBB", roomId: "2", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeBlue", token: "b",requestedBy: []),
        ...
        [User(id: "JJJJ", roomId: "10", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeYellow", token: "j",requestedBy: []),
    ...
    [
        [User(id: "ae2Nnjfb8HOYCfIDUxHFd1BLEVp1", roomId: "1", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeYellow", token: "a",requestedBy: []),
         User(id: "R1AB9xbuLCNvk15ld0fOonnhtXU2", roomId: "2", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeBlue", token: "b",requestedBy: []),
        ...
        [User(id: "JJJJ", roomId: "10", aptId: "1", userState: "vacant", lastActiveDate: Date(), eyeColor: "eyeYellow", token: "j",requestedBy: []),
         User(id: "KKKK", roomId: "11", aptId: "1", userState: "active", lastActiveDate: Date(), eyeColor: "eyeBlue", token: "k",requestedBy: []),
         User(id: "LLLL", roomId: "12", aptId: "1", userState: "inactive", lastActiveDate: Date(), eyeColor: "eyeCyan", token: "l",requestedBy: [])]
    ]
}
